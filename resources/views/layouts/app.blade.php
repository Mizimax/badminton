      ...
      <div class="menu-background"></div>
        <div class="menu-content">
          ...
          @endif
            ...
            <!-- <div class="menu-white coin" style="position: relative;background:#fc9ae9" onclick="window.location='/coin_shop'">
                <div class="org-icon coin-icon img-circle"style="background:#EC514F;">
                    <img src="/images/icon/gang.png" class="absolute middle" width="50">
                </div>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <i class="font-bold font-big" style="color:#4d4d4d">ก๋วน</i>
            </div> -->
