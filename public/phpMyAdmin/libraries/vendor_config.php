 ...
 */
define('AUTOLOAD_FILE', '/usr/share/phpMyAdmin/vendor/autoload.php');
 ...
 */
define('CHANGELOG_FILE', '/usr/share/doc/phpMyAdmin-4.8.1/ChangeLog');

/**
 * Path to license file. Useful when you want to have documentation somewhere
 * else, eg. /usr/share/doc.
 */
define('LICENSE_FILE', '/usr/share/licenses/phpMyAdmin-4.8.1/LICENSE');
