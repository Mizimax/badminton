...
<div id="content">
  ...
  <div class="form">
      <div class="row">
        ...
        <div class="col-sm-7">
          <div class="dropdown-container" style="width: 180px; position: relative;">
            <div class="hide">
              <input type="text" value="1" id="org_create_time" name="org_create_time">
            </div>
            <div class="input" align="center"><span class="display">1</span> <span class="icon dropdown">▼</span></div>
      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="org_last_create" name="org_last_create" style="width: 250px;">
        </div>
      </div>
  </div>
</div>
<div class="upload">
    <div class="upload-box">
      ...
      <div class="absolute middle">
        ...
        <div class="text"></div>
        <span class="glyphicon glyphicon-ok-circle" style="color: #D9E021;display: none"></span>
      </div>
      <div class="progress">
