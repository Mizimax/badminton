...
<div class="wrapper">
    <div class="side-bar">
        <ul>
            <li class="menu-head" >
                {{--CLASH OF CLANS--}}
                {{--<a href="#" class="push_menu" style="padding: 20px;">--}}
                    {{--<span class="glyphicon glyphicon-align-justify pull-left"></span>--}}
                {{--</a>--}}
            </li>
            <div class="menu">
                <li>
                    <a id="active_2" href="{{ URL::to('/page2') }}" class="{{current_page('page2') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;ใบปริ้นสาย
                        <span class="fa fa-sitemap pull-left" aria-hidden="true"  style="padding-top: 4px"></span>
                    </a>

                </li>

                <li>
                    <a id="active_3" href="{{ URL::to('/page3') }}" class="{{current_page('page3') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;กรอกคะแนน
                        <span class="fa fa-trophy pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>

                <li>
                    <a id="active_4" href="{{ URL::to('/page4') }}" class="{{current_page('page4') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;ปริ้นใบคะแนน
                        <span class="fa fa-print pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>
                <li>
                    <a id="active_5" href="{{ URL::to('/page5') }}" class="{{current_page('page5') ? 'active' : '' }}" >&nbsp;&nbsp;&nbsp;&nbsp;กรรมการ
                        <span class="fa fa-user pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>
                <li>
                    <a id="active_6" href="{{ URL::to('/page6') }}" class="{{current_page('page6') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;กิจกรรมพิเศษ
                        <span class="fa fa-flag pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>
                <li>
                    <a id="active_7" href="{{ URL::to('/page7') }}" class="{{current_page('page7') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;TV
                        <span class="fa fa-television pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>
                <li>
                    <a id="active_8" href="{{ URL::to('/page8') }}" class="{{current_page('page8') ? 'active' : '' }}">&nbsp;&nbsp;&nbsp;&nbsp;รูปภาพ
                        {{--<i class="fa fa-television pull-left" aria-hidden="true"></i>--}}
                        <span class="fa fa-picture-o pull-left" aria-hidden="true" style="padding-top: 4px"></span>
                    </a>
                </li>
            </div>
